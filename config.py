...
def parse_args():
	...
	parser.add_argument('-h', '--thresh', dest="DARKNET_THRESH", default=.25, type=float, help="Darknet threshold for successful classification (lower = more bounding boxes)")
	...
	parser.add_argument('--weights', dest="DARKNET_WEIGHTS", default="yolo-obj_1600.weights", help="Weights for Darknet")
	...
	parser.add_argument('-n', '--label_name', dest='LABEL_NAME', default='label', help="Name of label for detection")
